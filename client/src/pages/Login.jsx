    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }} className="fade-in">
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: 'var(--color-text)' }}>SplitEase</h1>
        ...
        <div className="card" style={{ borderColor: 'var(--color-border)' }}>
          <h2 style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '1.5rem' }}>Sign in to your account</h2>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input id="login-email" className="input" style={{ paddingLeft: '2.25rem' }} type="email" placeholder="you@example.com"
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input id="login-password" className="input" style={{ paddingLeft: '2.25rem', paddingRight: '2.5rem' }}
            ...
            <button id="login-btn" className="btn-primary" type="submit" disabled={loading} style={{ marginTop: '0.5rem', width: '100%', padding: '0.75rem' }}>
